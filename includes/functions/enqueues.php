...
if (!function_exists('b4st_enqueues')) {
    ...
    function b4st_enqueues() {
        ...
        $config = array(
            'assetsUrl' => POGO_config::get('AssetsUrl'),
            'siteUrl'   => POGO_config::get('appUrl'),
        ...
        wp_register_style('mdtimepicker-css', get_template_directory_uri() . '/theme/css/mdtimepicker.css', false, $version);
        wp_enqueue_style('mdtimepicker-css');
        ...
        wp_register_script('mdtimepicker-js', get_template_directory_uri() . '/theme/js/mdtimepicker.js', array('jquery'), null, true);
        //wp_enqueue_script('mdtimepicker-js');
